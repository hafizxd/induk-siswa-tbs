...
class StudentsExport extends \PhpOffice\PhpSpreadsheet\Cell\StringValueBinder implements FromQuery, WithHeadings, WithMapping, ShouldAutoSize, WithCustomValueBinder, WithStyles
{
    ...
    private function wrapStudentArr($student): array
    {
        ...
        return [
            ...
            convertDateFormat($student->tanggal_lahir, 'Y-m-d', 'd/m/Y'),
            ...
            $ayah->nik ?? '',
            $ayah->tempat_lahir ?? '',
            convertDateFormat($ayah->tanggal_lahir, 'Y-m-d', 'd/m/Y'),
            $ayah->pendidikan ?? '',
            $ayah->pekerjaan ?? '',
            $ayah->penghasilan ?? '',
            $ayah->nomor_hp ?? '',
            ...
            $ibu->nik ?? '',
            $ibu->tempat_lahir ?? '',
            convertDateFormat($ibu->tanggal_lahir, 'Y-m-d', 'd/m/Y'),
            $ibu->pendidikan ?? '',
            $ibu->pekerjaan ?? '',
            $ibu->penghasilan ?? '',
            $ibu->nomor_hp ?? '',
            ...
            $wali->nik ?? '',
            $wali->tempat_lahir ?? '',
            convertDateFormat($wali->tanggal_lahir, 'Y-m-d', 'd/m/Y'),
            $wali->pendidikan ?? '',
            $wali->pekerjaan ?? '',
            $wali->penghasilan ?? '',
            $wali->nomor_hp ?? '',
