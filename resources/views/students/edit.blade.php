            ...
            <div class="card">
                <div class="card-body px-5">
                    <ul class="nav nav-tabs border-tab nav-primary" id="info-tab" role="tablist">
                        <li class="nav-item" style="flex-grow:1;"><a class="nav-link active" id="info-home-tab" data-bs-toggle="tab" href="#info-home" role="tab" aria-controls="info-home" aria-selected="true"><i class="icofont icofont-man-in-glasses"></i>Informasi Siswa</a></li>
                        <li class="nav-item" style="flex-grow:1;"><a class="nav-link" id="profile-info-tab" data-bs-toggle="tab" href="#info-profile" role="tab" aria-controls="info-profile" aria-selected="false"><i class="icofont icofont-read-book"></i>Nilai Akademik</a></li>
                    </ul>
                    ...
                    <div class="tab-content" id="info-tabContent">
                        ...
                        <div class="tab-pane fade" id="info-profile" role="tabpanel" aria-labelledby="profile-info-tab">
                            {!! Form::open(['route' => ['students.update.score', $student->id]]) !!}
                            @method('PUT')
                                ...
                                <div class="col-sm-6">
                                    @foreach ($leftSubjects as $subject)
                                        ...
                                        <div class="form-group col-sm-10">
                                            ...
                                            {!! Form::number($subject->id, $val, ['class' => 'form-control', 'maxlength' => 20, 'maxlength' => 20]) !!}
                                            @error($subject->id)
                                                <p class="text-danger">{{ $message }}</p>
                                            @enderror
                                        </div>
