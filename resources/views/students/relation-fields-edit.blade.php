...
<div class="row">
    <div class="col-sm-6">
        ...
        <div class="form-group col-sm-10">
            ...
            {!! Form::text($prefixType . '[nama]', $relationInfo->nama, ['class' => 'form-control', 'maxlength' => 35, 'maxlength' => 35]) !!}
        ...
        <div class="form-group col-sm-10">
            ...
            {!! Form::text($prefixType . '[status]', $relationInfo->status, ['class' => 'form-control', 'maxlength' => 35, 'maxlength' => 35]) !!}
        ...
        <div class="form-group col-sm-10">
            ...
            {!! Form::text($prefixType . '[kewarganegaraan]', $relationInfo->kewarganegaraan, ['class' => 'form-control', 'maxlength' => 35, 'maxlength' => 35]) !!}
        ...
        <div class="form-group col-sm-10">
            ...
            {!! Form::text($prefixType . '[nik]', $relationInfo->nik, ['class' => 'form-control', 'maxlength' => 35, 'maxlength' => 35]) !!}
        ...
        <div class="form-group col-sm-10">
            ...
            {!! Form::text($prefixType . '[tempat_lahir]', $relationInfo->tempat_lahir, ['class' => 'form-control', 'maxlength' => 35, 'maxlength' => 35]) !!}
        ...
        <div class="form-group col-sm-10">
            ...
            {!! Form::text($prefixType . '[tanggal_lahir]', $relationInfo->tanggal_lahir, ['class' => 'form-control datepicker-here', 'id' => 'tanggal_lahir']) !!}
        ...
        <div class="form-group col-sm-10">
            ...
            {!! Form::text($prefixType . '[pendidikan]', $relationInfo->pendidikan, ['class' => 'form-control', 'maxlength' => 35, 'maxlength' => 35]) !!}
        ...
        <div class="form-group col-sm-10">
            ...
            {!! Form::text($prefixType . '[pekerjaan]', $relationInfo->pekerjaan, ['class' => 'form-control', 'maxlength' => 35, 'maxlength' => 35]) !!}
        ...
        <div class="form-group col-sm-10">
            ...
            {!! Form::number($prefixType . '[penghasilan]', $relationInfo->penghasilan, ['class' => 'form-control']) !!}
        ...
        <div class="form-group col-sm-10">
            ...
            {!! Form::text($prefixType . '[nomor_hp]', $relationInfo->nomor_hp, ['class' => 'form-control', 'maxlength' => 15, 'maxlength' => 15]) !!}
        ...
        @if($type == "AYAH")
            ...
            <div class="form-group col-sm-10">
                ...
                {!! Form::text($prefixType . '[tinggal_luar_negeri]', $relationInfo->tinggal_luar_negeri, ['class' => 'form-control', 'maxlength' => 35, 'maxlength' => 35]) !!}
            ...
            <div class="form-group col-sm-10">
                ...
                {!! Form::text($prefixType . '[kepemilikan_rumah]', $relationInfo->kepemilikan_rumah, ['class' => 'form-control', 'maxlength' => 35, 'maxlength' => 35]) !!}
    ...
    <div class="col-sm-6">
        ...
        <div class="form-group col-sm-10">
            ...
            {!! Form::text($prefixType . '[provinsi]', $relationInfo->provinsi, ['class' => 'form-control', 'maxlength' => 20, 'maxlength' => 20]) !!}
        ...
        <div class="form-group col-sm-10">
            ...
            {!! Form::text($prefixType . '[kota]', $relationInfo->kota, ['class' => 'form-control', 'maxlength' => 20, 'maxlength' => 20]) !!}
        ...
        <div class="form-group col-sm-10">
            ...
            {!! Form::text($prefixType . '[kecamatan]', $relationInfo->kecamatan, ['class' => 'form-control', 'maxlength' => 20, 'maxlength' => 20]) !!}
        ...
        <div class="form-group col-sm-10">
            ...
            {!! Form::text($prefixType . '[desa]', $relationInfo->desa, ['class' => 'form-control', 'maxlength' => 20, 'maxlength' => 20]) !!}
        ...
        <div class="form-group col-sm-10">
            ...
            {!! Form::text($prefixType . '[rt]', $relationInfo->rt, ['class' => 'form-control', 'maxlength' => 5, 'maxlength' => 5]) !!}
            @error($prefixType . '.rt')
                <p class="text-danger">{{ $message }}</p>
            @enderror
        </div>
        ...
        <div class="form-group col-sm-10">
            ...
            {!! Form::text($prefixType . '[rw]', $relationInfo->rw, ['class' => 'form-control', 'maxlength' => 5, 'maxlength' => 5]) !!}
            @error($prefixType . '.rw')
                <p class="text-danger">{{ $message }}</p>
            @enderror
        </div>
        ...
        <div class="form-group col-sm-10">
            ...
            {!! Form::text($prefixType . '[kode_pos]', $relationInfo->kode_pos, ['class' => 'form-control', 'maxlength' => 8, 'maxlength' => 8]) !!}
        ...
        <div class="form-group col-sm-12 col-lg-12">
            ...
            {!! Form::textarea($prefixType . '[alamat]', $relationInfo->alamat, ['class' => 'form-control']) !!}
